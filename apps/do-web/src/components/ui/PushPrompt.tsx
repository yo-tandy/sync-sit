...
// Mirrors apps/study-web/src/components/ui/PushPrompt.tsx: a soft prompt
// shown once, only in installed-PWA mode, that asks before triggering the
// browser's own permission dialog (plan §13 PR9).
