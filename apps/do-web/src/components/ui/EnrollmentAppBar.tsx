...
/**
 * Sync-do version of the enrollment chrome (sticky branded bar + hamburger
 * menu), mirroring study-web's EnrollmentAppBar for the post-Step-Password
 * phase of doer enrollment. Like study's, no Sign Out item: on the classic
 * path the account doesn't exist until the final step calls doEnrollDoer.
 */
