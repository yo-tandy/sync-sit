...
// PWA gating pins for the soft push prompt (plan §13 PR9), ported from
// study-web's twin suite (PR #334 review: do-web shipped the component
// untested). The branches worth pinning are the ones that decide whether a
// native permission dialog appears unbidden: never prompt in a regular
// browser tab, never prompt twice (`wasPrompted`), and refresh the token
