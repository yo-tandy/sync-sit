export default {
  ...
  welcome: {
    title: 'Sync/Study',
    subtitle: 'Connectez-vous avec les tuteurs EJM pour des sessions personnalisées',
    ctaSignUp: 'Commencer',
  ...
  enrollment: {
    tutor: {
      ...
      stepSubjects: 'Matières enseignées',
    ...
    subjectsSubtitle: 'Ajoutez les matières que vous pouvez enseigner, avec les niveaux et votre tarif horaire.',
    subject: 'Matière',
