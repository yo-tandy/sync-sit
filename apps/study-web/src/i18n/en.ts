export default {
  ...
  tutor: {
    ...
    publishedBoard: {
      ...
      contactCooldown_one: 'This family declined your last request. You can try again in {{count}} day.',
      contactCooldown_other: 'This family declined your last request. You can try again in {{count}} days.',
    ...
    sessions: {
      ...
      instancesLoading: 'Loading dates…',
      instancesLoadError: "Couldn't load this series' dates.",
      instancesRetry: 'Try again',
  ...
  family: {
    ...
    dashboard: {
      ...
      // Marks a request WE sent: the badge counts only what we must answer.
      awaitingTutorReply: 'Waiting for the tutor to reply.',
    ...
    sessions: {
      ...
      notes: {
        ...
        remove: 'Remove note',
        removeTitle: 'Remove this note?',
        removeDesc: 'The tutor will no longer see it.',
        removeConfirm: 'Remove it',
        removeError: "Couldn't remove your note. It's still there — please try again.",
