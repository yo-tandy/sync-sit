...
import { TopNav, Spinner } from '@ejm/shared-ui';
...
/**
 * /notifications for tutor and family portals (issue #127, UX F13). ONE
 * component mounted under both role layouts (the layouts guard; the role only
 * picks the back target and the tap route). Newest-first — the shared store's
 * query orders by createdAt desc. A tap marks the row read (ONLY the read key
...
export function NotificationsPage() {
  ...
  const backTo = role === 'tutor' ? '/tutor' : '/family';
