  ...
  return (
    <div>
      ...
      <div className="px-5 pt-4 pb-8">
        ...
        <Step number={5} title={fr ? 'Envoyer une demande de contact' : 'Send a contact request'}>
          <p>
            {fr
        ...
        <Step number={6} title={fr ? 'L\'approbation débloque la relation' : 'Approval unlocks the relationship'}>
          <p>
            {fr
        ...
        <Step number={7} title={fr ? 'Réserver une séance' : 'Book a session'}>
          <p>
            {fr
        ...
        <Step number={8} title={fr ? 'Propositions du tuteur' : 'Tutor proposals'}>
          <p>
            {fr
        ...
        <Step number={9} title={fr ? 'Suivre vos séances' : 'Track your sessions'}>
          <p>
            {fr
              ? 'Votre page "Séances" regroupe tout : demandes en attente, séances confirmées à venir et historique. Les séances récurrentes affichent la liste de leurs dates.'
              : 'Your "Sessions" page shows everything: pending requests, upcoming confirmed sessions, and history. Recurring sessions expand into their list of dates.'}
          </p>
        </Step>

        <Step number={10} title={fr ? 'Modifier ou annuler' : 'Modify or cancel'}>
          <p>
            {fr
        ...
        <Step number={13} title={fr ? 'Mon compte et notifications' : 'My Account & notifications'}>
          <p>
            {fr
