    ...
    <div>
      ...
      <div className="px-5 pt-4 pb-8">
        ...
        <Step number={5} title={fr ? 'Publier votre recherche' : 'Publish your search'}>
          <p>
            {fr
              ? 'Pas de résultat concluant ? Vous pouvez publier votre recherche pour que les tuteurs viennent à vous. Une recherche publiée est visible par un plus grand nombre de tuteurs — y compris ceux qui ne correspondent pas à vos critères — et montre votre nom de famille, votre quartier, la matière et le niveau, ainsi que vos lieux de séance préférés et votre tarif maximum si vous en avez indiqué ; votre adresse n\'est jamais affichée. Les tuteurs intéressés vous envoient alors une demande de contact, que vous acceptez ou refusez depuis votre page "Demandes". Le nombre de recherches publiées simultanées est limité ; chacune expire automatiquement au bout d\'un certain temps et peut être retirée à tout moment.'
              : 'No luck in the results? You can publish your search so tutors come to you. A published search is visible to a larger group of tutors — including ones who don\'t match your search terms — and shows your family name, your area, the subject and level, and your preferred session locations and maximum rate if you set them; your address is never shown. Interested tutors then send you a contact request, which you accept or decline from your "Requests" page. The number of published searches you can have at a time is limited; each expires automatically after a while and can be withdrawn at any time.'}
          </p>
        </Step>
        ...
        <Step number={12} title={fr ? 'Laisser une recommandation' : 'Leave an endorsement'}>
          <p>
            {fr
              ? 'Une fois votre demande de contact acceptée par un tuteur, vous pouvez lui laisser une recommandation (une par tuteur) depuis sa carte sur vos pages "Demandes" ou "Vos cours". "Mes recommandations" dans le menu sert à consulter et gérer celles que vous avez soumises. Votre recommandation est envoyée au tuteur, qui choisit de la publier ou non pour les autres familles.'
              : 'Once a tutor has accepted your contact request, you can leave them one endorsement from their card on your "Requests" or "Your sessions" pages. "My endorsements" in the menu is where you review and manage the ones you\'ve submitted. Your endorsement is sent to the tutor, who chooses whether to publish it for other families to see.'}
          </p>
        </Step>
