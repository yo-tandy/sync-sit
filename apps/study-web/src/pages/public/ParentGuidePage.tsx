    ...
    <div>
      ...
      <div className="px-5 pt-4 pb-8">
        ...
        <Step number={5} title={fr ? 'Publier votre recherche' : 'Publish your search'}>
          <p>
            {fr
              ? 'Pas de résultat concluant ? Vous pouvez publier votre recherche pour que les tuteurs viennent à vous. Une recherche publiée est visible par un plus grand nombre de tuteurs — y compris ceux qui ne correspondent pas à vos critères — et montre votre nom de famille, votre quartier, la matière et le niveau, ainsi que vos lieux de séance préférés et votre tarif maximum si vous en avez indiqué ; votre adresse n\'est jamais affichée. Les tuteurs intéressés vous envoient alors une demande de contact, que vous acceptez ou refusez depuis votre page "Demandes". Vous pouvez avoir jusqu\'à 3 recherches publiées à la fois ; chacune reste visible une semaine et peut être retirée à tout moment.'
              : 'No luck in the results? You can publish your search so tutors come to you. A published search is visible to a larger group of tutors — including ones who don\'t match your search terms — and shows your family name, your area, the subject and level, and your preferred session locations and maximum rate if you set them; your address is never shown. Interested tutors then send you a contact request, which you accept or decline from your "Requests" page. You can have up to 3 published searches at a time; each stays up for one week and can be withdrawn at any time.'}
          </p>
        </Step>
