...
/**
 * Dedicated family appointments page (issue #241, parity Q1 = b) — the sit
 * mirror of study's family SessionsPage (a first-class page the dashboard
 * summary links to, instead of the full list living inline on the dashboard).
 *
 * Same four states the dashboard used to render inline:
 *   • Pending   — grouped by date/time; cancel / edit / accept-decline
 *                 (babysitter-initiated published-search answers).
 *   • Confirmed — upcoming confirmed appointments.
 *   • Past      — recent completed appointments (reference prompt + dialog).
 *   • Declined  — recent rejected/cancelled (resubmit).
 *
 * All appointment data comes live from useFamilyAppointments (onSnapshot);
 * every action calls the SAME callables the dashboard called — no callable,
 * rule, or data-shape change in this move.
 */
      ...
      <div className="px-5 pt-4 pb-8">
        ...
        {aptsLoading ? (
          ...
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <Button size="sm" onClick={() => navigate('/family/search')}>
        ...
        <Dialog open={!!cancelTarget} onClose={() => { setCancelTarget(null); setCancelReason(''); }}>
          {(() => {
            ...
            //
            // Moved here with the dialog it belongs to: #248 added it to the
            // family dashboard, and this PR is what relocated that dialog.
