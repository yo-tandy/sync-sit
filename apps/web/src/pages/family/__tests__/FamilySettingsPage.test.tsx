...
// updateDoc and syncs kids via addDoc / updateDoc / deleteDoc.
const h = vi.hoisted(() => ({
  auth: {
...
vi.mock('firebase/storage', () => ({
  ...
  getDownloadURL: (_ref: { path: string }) => h.getDownloadURL(),
...
describe('family FamilySettingsPage', () => {
  ...
  it('adds a new child (with languages seeded) to families/{id}/kids on save', async () => {
    renderPage();
    await screen.findByLabelText(/family name/i);
