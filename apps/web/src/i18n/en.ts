export default {
  ...
  publish: {
    ...
    durationOneTime: 'The published search stays up for at most a week, and no longer than the babysitting date.',
    durationRecurring: 'The published search stays up for one week.',
