export default {
  ...
  references: {
    title: 'References',
    myReferences: 'Manually entered references',
    noReferencesYet: 'No references added yet',
    addReference: 'Add a reference',
    addReferenceDesc: 'Search for the babysitter you want to leave a reference for',
    ...
    referencePromptDesc: 'Leave a reference to help {{name}} and other families',
