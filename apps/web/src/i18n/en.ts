export default {
  ...
  publishedBoard: {
    ...
    contactCooldown: 'This family declined your last request for this search. You can try again in {{days}} days.',
    contactCap: 'You have contacted several families in the last {{hours}} hours. You can send more requests once the window passes.',
