export default {
  ...
  familyDashboard: {
    ...
    notes: {
      ...
      edit: 'Edit note',
      remove: 'Remove note',
      removeConfirm: 'Remove this note? The babysitter will no longer see it, and the editing window has closed — you cannot write a new one.',
  ...
  request: {
    ...
    notes: {
      ...
      remove: 'Remove note',
      removeConfirm: 'Remove this note? The family will no longer see it.',
