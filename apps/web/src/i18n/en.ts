export default {
  ...
  // `t()` against whatever the host app has loaded.
  unifiedEnrollment: {
  ...
  familyDashboard: {
    ...
    returningBadge: 'Returning babysitter',
    classLabel: 'Class:',
  ...
  admin: {
    ...
    // Sync/Do tasks (sync-do plan §9.4). Admin tooling only — sync-do has
    // no admin tree of its own, and nothing here is member-facing.
    doTasks: {
      title: 'Sync/Do tasks',
      navDesc: 'Browse, filter and remove posted tasks; inspect their offers',
      search: 'Search by title, family, area or task ID...',
      categoryLabel: 'Category',
      allCategories: 'All categories',
      familyFilter: 'Filter by family ID...',
      taskLabel: 'Task',
      offersLabel: 'Live offers',
      offersTitle: 'Offers',
      noOffers: 'No offers on this task',
      offersError: 'Could not load offers. Please try again.',
      offerPrice: '{{price}} € {{basis}}',
      helper: '+1 helper: {{name}}, age {{age}} — no Sync account, not verified',
      taskId: 'Task ID: {{id}}',
  ...
  verification: {
    ...
    rejectDesc: 'A reason is required. It is emailed to the family\'s parents with a reply-to of support@sync-sit.com, so write it for them.',
