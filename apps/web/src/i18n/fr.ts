export default {
  ...
  familyDashboard: {
    ...
    notes: {
      ...
      removeConfirm: 'Supprimer cette note ? Le babysitter ne la verra plus, et la fenêtre de modification est fermée — vous ne pourrez pas en écrire une nouvelle.',
  ...
  request: {
    ...
    notes: {
      ...
      remove: 'Supprimer la note',
      removeConfirm: 'Supprimer cette note ? La famille ne la verra plus.',
