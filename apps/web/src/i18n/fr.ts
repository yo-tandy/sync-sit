export default {
  ...
  references: {
    title: 'R\u00e9f\u00e9rences',
    myReferences: 'Références saisies manuellement',
    noReferencesYet: 'Aucune référence ajoutée',
    addReference: 'Ajouter une référence',
    addReferenceDesc: 'Recherchez le babysitter pour lequel vous souhaitez laisser une référence',
  ...
  notifications: {
    ...
    references: 'Mises à jour des références',
    referencesDesc: 'Quand une famille soumet une référence pour vous',
