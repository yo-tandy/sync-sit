export default {
  ...
  // Verification
  verification: {
    title: 'Vérification familiale',
    menuTitle: 'Vérification',
    required: 'Vérification requise',
    requiredDesc: 'Veuillez vérifier votre identité et télécharger le document d\'inscription EJM de votre enfant pour rechercher des babysitters.',
    completeVerification: 'Compléter la vérification',
    statusOverview: 'Statut de vérification',
    fullyVerified: 'Votre famille est entièrement vérifiée',
    identityTitle: 'Vérification d\'identité',
    identityDesc: 'Téléchargez un scan ou une photo de votre carte d\'identité nationale ou passeport.',
    enrollmentTitle: 'Documents d\'inscription EJM',
    ...
    reupload: 'Télécharger un nouveau document',
    pending: 'En attente de vérification',
    approved: 'Approuvé',
    rejected: 'Rejeté',
    notSubmitted: 'Non soumis',
    rejectionReason: 'Raison du rejet',
    addEnrollment: 'Ajouter un document d\'inscription',
    childName: 'Nom complet de l\'enfant',
    childDob: 'Date de naissance de l\'enfant',
    schoolYear: 'Année scolaire (ex : 2025-2026)',
    classLevel: 'Niveau de classe',
    signerName: 'Nom du signataire (parent)',
    fileTooLarge: 'Le fichier est trop volumineux. Taille maximale : 10 Mo.',
    invalidFileType: 'Type de fichier invalide. Veuillez télécharger une image ou un PDF.',
    uploadSuccess: 'Document téléchargé avec succès',
    searchRestricted: 'La recherche est restreinte tant que votre famille n\'est pas entièrement vérifiée.',
    identity: 'Identité',
