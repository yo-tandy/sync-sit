export default {
  ...
  publishedBoard: {
    ...
    contactCooldown: 'Cette famille a refusé votre dernière demande pour cette recherche. Vous pourrez réessayer dans {{days}} jours.',
    contactCap: 'Vous avez contacté plusieurs familles au cours des dernières {{hours}} heures. Vous pourrez envoyer de nouvelles demandes une fois ce délai passé.',
