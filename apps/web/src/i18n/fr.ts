export default {
  ...
  publish: {
    ...
    durationOneTime: 'La recherche publiée reste visible au maximum une semaine, et jamais au-delà de la date du babysitting.',
    durationRecurring: 'La recherche publiée reste visible pendant une semaine.',
