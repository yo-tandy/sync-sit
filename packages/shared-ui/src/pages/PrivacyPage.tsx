...
const sections: Section[] = [
  ...
  },
  {
    ...
    contentEn:
      ...
      'There is no single upper age limit, because the apps differ. On Sync/Sit and Sync/Study a provider\'s date of birth must also stay consistent with their EJM school year, which in practice means students aged 15 to 18. The two apps enforce it differently: Sync/Study refuses the enrollment outright, while Sync/Sit accepts it and instead stops showing that provider to families. An administrator can grant an exemption, and the Sync/Sit check is skipped where we hold no date of birth. On Sync/Do there is no upper limit.\n\n' +
    ...
    contentFr:
      ...
      'Il n\'existe pas de limite d\'âge supérieure unique, car les applications diffèrent. Sur Sync/Sit et Sync/Study, la date de naissance d\'un prestataire doit en outre rester cohérente avec son année scolaire à l\'EJM, ce qui correspond en pratique à des élèves de 15 à 18 ans. Les deux applications l\'appliquent différemment : Sync/Study refuse purement et simplement l\'inscription, tandis que Sync/Sit l\'accepte mais cesse de présenter ce prestataire aux familles. Un administrateur peut accorder une dérogation, et la vérification de Sync/Sit est écartée lorsque nous ne disposons d\'aucune date de naissance. Sur Sync/Do, il n\'existe aucune limite supérieure.\n\n' +
