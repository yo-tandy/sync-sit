...
const sections: Section[] = [
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Location context: your address is never shown to other users. What is shown is an area label such as an arrondissement or commune, plus an approximate distance. Photos you upload are re-encoded on our servers and all embedded metadata, including EXIF location data, is removed before the photo is stored or shown to anyone.\n' +
    ...
    contentFr:
      ...
      '- Contexte de localisation : votre adresse n\'est jamais affichée aux autres utilisateurs. Seuls sont affichés un libellé de secteur (arrondissement ou commune) et une distance approximative. Les photos que vous téléchargez sont réencodées sur nos serveurs et toutes les métadonnées intégrées, y compris les données de géolocalisation EXIF, sont supprimées avant que la photo ne soit stockée ou montrée à quiconque.\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Their details are deleted when the offer is deleted, which is at the latest 6 months after the task is completed or 30 days after it is cancelled (see section 7).\n' +
    ...
    contentFr:
      ...
      '- Elles sont supprimées en même temps que la proposition, soit au plus tard 6 mois après l\'achèvement de la mission ou 30 jours après son annulation (voir la section 7).\n' +
