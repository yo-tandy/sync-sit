...
const sections: Section[] = [
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Other users: your profile information (name, photo, bio, languages, availability, and the service details a provider publishes) is visible to other verified users of the platform. Your address is not displayed; only an area label and an approximate distance are shown.\n' +
      ...
      '- The other party to an engagement you accept: once a family accepts a service provider for a specific appointment, session or task, the two are shown each other\'s contact details — the family\'s address and its parents\' names, email and phone, and the service provider\'s name, email and phone. On Sync/Do this exchange is served live at the moment you look at it and is never stored on the offer, and it stops being available once the engagement is over (for a cancelled task, seven days after cancellation). On Sync/Sit the address you accepted with is recorded on the appointment itself, and goes when that appointment does under section 7.\n- A supervising parent: if a service provider has a supervised account, their supervising parent can see the offers that require their approval, including the task they relate to.\n' +
    ...
    contentFr:
      ...
      '- Autres utilisateurs : vos informations de profil (nom, photo, biographie, langues, disponibilités et les détails du service publiés par un prestataire) sont visibles par les autres utilisateurs vérifiés de la plateforme. Votre adresse n\'est pas affichée ; seuls un libellé de secteur et une distance approximative sont indiqués.\n' +
      ...
      '- L\'autre partie à une intervention que vous acceptez : lorsqu\'une famille accepte un prestataire pour un rendez-vous, une séance ou une mission déterminés, les deux parties se voient communiquer leurs coordonnées respectives — l\'adresse de la famille ainsi que les nom, prénom, e-mail et téléphone de ses parents, et les nom, prénom, e-mail et téléphone du prestataire. Sur Sync/Do, cet échange est servi en direct au moment où vous le consultez, n\'est jamais enregistré sur la proposition, et cesse d\'être accessible une fois l\'intervention terminée (pour une mission annulée, sept jours après l\'annulation). Sur Sync/Sit, l\'adresse pour laquelle vous avez donné votre accord est enregistrée sur le rendez-vous lui-même et disparaît en même temps que ce rendez-vous, au titre de la section 7.\n- Un parent superviseur : si un prestataire dispose d\'un compte supervisé, son parent superviseur peut consulter les propositions soumises à son approbation, ainsi que la mission concernée.\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Notes attached to a booking: removed once the booking has left every screen in the app\n' +
      ...
      'Some records have no automatic expiry and are kept until you delete your account or the record itself: an ongoing recurring arrangement that has no end date, a task that was assigned but that neither side ever closed, and a cancelled or declined tutoring session.\n\n' +
    ...
    contentFr:
      ...
      '- Notes attachées à une réservation : supprimées dès que la réservation n\'apparaît plus sur aucun écran de l\'application\n' +
      ...
      'Certains enregistrements n\'ont pas d\'expiration automatique et sont conservés jusqu\'à ce que vous supprimiez votre compte ou l\'enregistrement lui-même : un arrangement récurrent en cours sans date de fin, une mission attribuée que ni l\'une ni l\'autre des parties n\'a clôturée, et une séance de soutien scolaire annulée ou refusée.\n\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      'We do not collect data directly from children. All of it is provided with parental consent as part of the parent\'s account creation and profile management.\n\n' +
      ...
      'We do not set an upper age limit for service providers.\n\n' +
    ...
    contentFr:
      ...
      'Nous ne collectons aucune donnée directement auprès des enfants. Elles sont toutes fournies avec le consentement parental dans le cadre de la création du compte et de la gestion du profil du parent.\n\n' +
      ...
      'Nous ne fixons aucune limite d\'âge supérieure pour les prestataires.\n\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      'That person has no account on {{brand}}, no relationship with us, and no way to use the in-app rights tools described in section 8. They are frequently a minor. We hold their data only because the student entered it, so that the family knows who to expect at their home.\n\n' +
    ...
    contentFr:
      ...
      'Cette personne n\'a pas de compte sur {{brand}}, n\'entretient aucune relation avec nous et ne peut pas utiliser les outils intégrés à l\'application décrits à la section 8. Il s\'agit fréquemment d\'un mineur. Nous détenons ses données uniquement parce que l\'élève les a saisies, afin que la famille sache qui se présentera à son domicile.\n\n' +
      'Concrètement :\n\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Secure file storage via Firebase Cloud Storage with restricted access rules. Photos uploaded to a Sync/Do task are quarantined, re-encoded server-side to remove all embedded metadata (including EXIF location data), and only then published; they are never served by a public URL.\n\n' +
