...
const sections: Section[] = [
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Verification documents: government-issued ID scans and school enrollment certificates (for families only). Service providers are verified through their @ejm.org school email address, or an address we have pre-approved.\n' +
      ...
      '- Location context: your address is not shown in search results, on profiles, or on the Sync/Do task board. What is shown there is an area label such as an arrondissement or commune, and — in search results only — an approximate distance. Your full address is shared with a service provider only once you accept them for a specific engagement — see section 5. Photos you upload are re-encoded on our servers and all embedded metadata, including EXIF location data, is removed before the photo is published or shown to anyone (see section 11).\n' +
    ...
    contentFr:
      ...
      '- Documents de vérification : copies de pièces d\'identité officielles et certificats de scolarité (pour les familles uniquement). Les prestataires sont vérifiés par leur adresse e-mail scolaire @ejm.org, ou par une adresse que nous avons approuvée au préalable.\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Affiliation verification: to verify the school affiliation of both families and service providers — families through identity documents and enrollment certificates, service providers through their @ejm.org school email, or a pre-approved address\n' +
    ...
    contentFr:
      ...
      '- Vérification d\'affiliation : pour vérifier l\'affiliation scolaire des familles et des prestataires — les familles par le biais de documents d\'identité et de certificats de scolarité, les prestataires par leur adresse e-mail scolaire @ejm.org, ou par une adresse pré-approuvée\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Legitimate interest (Article 6(1)(f)): we have a legitimate interest in verifying the school affiliation of families and service providers to ensure the safety of the children, families and students using the platform. This includes collecting and reviewing ID documents and school enrollment certificates from families, and verifying service providers through their @ejm.org school email, or a pre-approved address.\n\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Verified service providers, when your family publishes a request: a request you publish is readable by every active, fully enrolled provider of the app it was published on — including one who has chosen not to appear in search results. On Sync/Sit it carries your family name, an area label, the dates or weekly slots, the number of children and their ages, the rate you offer, and any free text you add. On Sync/Study it carries your family name, an area label, the subject and level, your location preferences and your maximum rate. Neither carries your address, and neither names a child. A published request expires and is then deleted — see section 7.\n' +
      '- The other party to an engagement you accept, once you accept it. What is exchanged differs by app. On Sync/Sit and Sync/Do the exchange is two-way: the service provider is shown the family\'s address and its parents\' names, email, phone and WhatsApp number, and the family is shown the provider\'s name, email, phone and WhatsApp number. On Sync/Study it is one-way: the tutor\'s email, phone and WhatsApp number are shared with the family, and nothing about the family beyond its name and the subject goes to the tutor — no address, and no parent contact details. Where the details are held also differs: on Sync/Do they are served live at the moment you look and are never stored on the offer, staying available while the task is assigned and after it is completed, until the task itself is deleted under section 7, and for seven days after a cancellation; on Sync/Sit the address you accepted with is recorded on the appointment itself, and goes when that appointment does under section 7.\n- A supervising parent: if a service provider has a supervised account, their supervising parent can see the offers that require their approval, including the task they relate to.\n' +
    ...
    contentFr:
      ...
      '- Autres utilisateurs : vos informations de profil (nom, photo, biographie, langues, disponibilités et les détails du service publiés par un prestataire) sont visibles par les autres utilisateurs vérifiés de la plateforme. Votre adresse ne leur est pas affichée ; seuls un libellé de secteur et, dans les résultats de recherche, une distance approximative le sont. La seule exception est un prestataire que vous acceptez — voir l\'entrée suivante.\n' +
      ...
      '- Les prestataires vérifiés, lorsque votre famille publie une demande : une demande que vous publiez est consultable par tous les prestataires actifs et pleinement inscrits de l\'application où elle est publiée — y compris ceux qui ont choisi de ne pas apparaître dans les résultats de recherche. Sur Sync/Sit, elle comporte votre nom de famille, un libellé de secteur, les dates ou créneaux hebdomadaires, le nombre d\'enfants et leur âge, le tarif que vous proposez et le texte libre que vous ajoutez. Sur Sync/Study, elle comporte votre nom de famille, un libellé de secteur, la matière et le niveau, vos préférences de lieu et votre tarif maximum. Ni l\'une ni l\'autre ne comporte votre adresse, et aucune ne nomme un enfant. Une demande publiée expire, puis est supprimée — voir la section 7.\n' +
      '- L\'autre partie à une intervention, une fois que vous l\'avez acceptée. Ce qui est communiqué diffère selon l\'application. Sur Sync/Sit et Sync/Do, l\'échange est réciproque : le prestataire reçoit l\'adresse de la famille ainsi que les nom, prénom, e-mail, téléphone et numéro WhatsApp de ses parents, et la famille reçoit les nom, prénom, e-mail, téléphone et numéro WhatsApp du prestataire. Sur Sync/Study, l\'échange est à sens unique : l\'e-mail, le téléphone et le numéro WhatsApp du tuteur sont communiqués à la famille, et rien de la famille au-delà de son nom et de la matière n\'est transmis au tuteur — ni adresse, ni coordonnées des parents. Le lieu de conservation diffère également : sur Sync/Do, ces informations sont servies en direct au moment où vous les consultez et ne sont jamais enregistrées sur la proposition ; elles restent accessibles pendant que la mission est attribuée et après son achèvement, jusqu\'à la suppression de la mission elle-même au titre de la section 7, ainsi que pendant sept jours après une annulation ; sur Sync/Sit, l\'adresse pour laquelle vous avez donné votre accord est enregistrée sur le rendez-vous lui-même et disparaît en même temps que ce rendez-vous, au titre de la section 7.\n- Un parent superviseur : si un prestataire dispose d\'un compte supervisé, son parent superviseur peut consulter les propositions soumises à son approbation, ainsi que la mission concernée.\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      'All three apps require a provider\'s date of birth to stay consistent with their EJM school year, which in practice means students aged 15 to 18 — but the three apps enforce it differently. Sync/Study and Sync/Do both refuse the enrollment outright. Sync/Sit accepts the enrollment and instead stops showing that provider to families. An administrator can grant an exemption on any of the three apps, and on Sync/Sit the check is skipped where we hold no date of birth.\n\n' +
    ...
    contentFr:
      ...
      'Les trois applications exigent que la date de naissance d\'un prestataire reste cohérente avec son année scolaire à l\'EJM, ce qui correspond en pratique à des élèves de 15 à 18 ans — mais les trois applications l\'appliquent différemment. Sync/Study et Sync/Do refusent tous deux purement et simplement l\'inscription. Sync/Sit l\'accepte mais cesse de présenter ce prestataire aux familles. Un administrateur peut accorder une dérogation sur l\'une quelconque des trois applications, et sur Sync/Sit la vérification est écartée lorsque nous ne disposons d\'aucune date de naissance.\n\n' +
  ...
  },
  {
    ...
    contentEn:
      ...
      '- Verification requirements: service providers must verify their school affiliation through their @ejm.org email address, or a pre-approved address; families must provide government ID and school enrollment proof before their profiles are published\n' +
    ...
    contentFr:
      ...
      '- Exigences de vérification : les prestataires doivent vérifier leur affiliation scolaire par leur adresse e-mail @ejm.org, ou par une adresse pré-approuvée ; les familles doivent fournir une pièce d\'identité officielle et un justificatif de scolarité avant la publication de leur profil\n' +
