...
// NOTE (#445 review): AccountHome previously rendered its own sticky
// "Sync/Account" header here, but that painted OVER AccountLayout's
// existing md+ desktop exit header (apps/web) at the same z-index -- two
// full-bleed headers stacked. The header now lives in the HOST layout
// (apps/web's AccountLayout, pinned in
// apps/web/src/layouts/__tests__/DesktopShell.test.tsx); AccountHome goes
// back to being page body only, so there is nothing header-shaped to pin
// here. What stays is the section order/title contract below.
